...
function gerarRelacaoGrafica() {
  ...
  sh.getRange(row,1,1,9).merge().setValue('Relação gerada somente com pedidos PAGO/CONFIRMADO e ainda NÃO ENVIADOS à gráfica. Dados pessoais do comprador e número do pedido não aparecem na relação enviada à gráfica; o controle dos pedidos fica apenas em colunas internas ocultas. Após enviar esta relação, use o menu “✅ Marcar relação atual como enviada à gráfica”.').setBackground('#F3F6F9').setFontColor('#4B5563').setFontStyle('italic').setWrap(true); row += 2;
